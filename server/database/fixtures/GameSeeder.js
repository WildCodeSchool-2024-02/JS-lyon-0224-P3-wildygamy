  ...
  run() {
    const games = [
      ...
      },
      {
        ...
        synopsis:
          "Pong est une version améliorée du jeu vidéo inspiré du tennis de table développé par Ralph Baer et son équipe à Sanders Associates en 1967. C'est le premier jeu vidéo à connaître un succès populaire. Il est notemment adapté en 1977 sur console Atari 2600 dans le jeu multi-sports Video Olympics.",
      },
      {
        name: "Space Invaders",
      ...
      },
      {
        ...
        synopsis:
          "Super Sidekicks est un jeu de football réaliste développé et édité par SNK en 1992.",
      },
      {
        name: "X-Men",
        category: "Beat'em up",
        ...
        synopsis:
          "Incarnez vos super héros préférés et sauvez le monde avec Professeur Xavier.",
      },
      {
        name: "Avengers",
        category: "Beat'em up",
