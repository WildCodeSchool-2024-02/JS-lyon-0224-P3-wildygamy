...
export default function RegistrationPage(handleSignUp) {
  ...
  const validInputs = () => {
    const {username, lastname, firstname, mail,password, password2} = registerForm;
    const fields = [
      {
        name: "username",
        value: username,
      ...
      },
      {
        ...
        minLength: 3,
        errorMessage: "Le nom doit être en majuscule et doit contenir au moins 3 caractères"
      },
      {
        name: "firstname",
        value: firstname,
        ...
        minLength: 2,
        errorMessage: "Le prénom doit commencer par une majuscule et doit contenir au moins 2 caractères"
      },
      {
        name: "mail",
        value: mail,
      ...
      },
      {
        ...
        minLength: 8,
        errorMessage: "Le mot de passe doit avoir 8 caractères minimum dont au moins une majuscule , un nombre et un caractère spécial"
      },
      {
        name: "password2",
        value: password2,
